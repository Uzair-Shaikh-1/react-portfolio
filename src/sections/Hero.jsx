...
const Hero = () => {
  return (
    <section className="relative min-h-screen flx items-center overflow-hidden">
      {/* bg */}
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                I build beyond the interface. I create the frontend, design the
                backend logic, build the APIs, and connect the data that makes
                an application actually work.
              </p>
            </div>
            {/* CTA */}
            <div className="">
              ...
              <AnimatedBorderButton
                onClick={() => window.open("/CV.pdf", "blank")}
              >
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/Uzair-Shaikh-1" },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/uzair-shaikh-376305394/",
                },
                { icon: Twitter, href: "https://x.com/DeveloperUzair" },
              ].map((social, idx) => {
                return (
                  <a
                    key={idx}
